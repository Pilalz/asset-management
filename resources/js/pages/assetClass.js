...
$(document).ready(function () {
    ...
    var table = $('#assetClassTable').DataTable({
        ...
        language: {
            ...
            emptyTable: `
                <div class="flex flex-col items-center justify-center p-8 text-gray-500 dark:text-gray-400">
                    ...
                    <p class="text-lg font-medium">No asset class data available</p>
                    <p class="text-sm mt-1">Please add a new asset class data.</p>
                </div>`,
            processing: `
                <style>
        ...
        columnDefs: [
            ...
            {
                targets: 2,
                className: 'px-6 py-4 text-gray-600 dark:text-gray-300 align-middle w-40'
            },
            {
                targets: 3,
                className: 'px-6 py-4 text-gray-600 dark:text-gray-300 align-middle',
                render: function (data, type, row) {
                    if (type === 'display') {
                        return '<div class="flex flex-col">' +
                            '<span class="text-xs font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wide">Direct Ownership</span>' +
                            '<span class="text-gray-800 dark:text-gray-200">' + data + '</span>' +
                            '</div>';
                    }
                    return data;
                }
