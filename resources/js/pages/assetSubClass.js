...
$(document).ready(function () {
    ...
    $('#assetSubClassTable thead tr#filter-row td').each(function (i) {
        var cell = $(this);
        if (i === 0 || i === 3) {
            return;
        }
            ...
            $(cell).html(
                `<select class="filter-select w-full p-2 text-xs border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 outline-none transition-colors shadow-sm">
            ...
            $(cell).html('<input type="text" class="w-full p-2 text-xs border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 outline-none transition-colors shadow-sm placeholder-gray-400" placeholder="Search..." />');
        }
    });
    ...
    var table = $('#assetSubClassTable').DataTable({
        ...
        language: {
            ...
            emptyTable: `
                <div class="flex flex-col items-center justify-center p-8 text-gray-500 dark:text-gray-400">
                    ...
                    <p class="text-lg font-medium">No asset sub class data available</p>
                    <p class="text-sm mt-1">Please add a new asset sub class data.</p>
                </div>`,
            processing: `
                <style>
        ...
        columnDefs: [
            ...
            {
                targets: 1,
                className: 'px-6 py-4 text-gray-700 dark:text-gray-300 align-middle w-56'
            },
            {
                targets: 2,
            ...
            {
                targets: 3,
                className: 'px-6 py-4 text-center whitespace-nowrap align-middle w-32'
            }
        ],
