...
$(document).ready(function () {
    if ($('#disposalAssetTable').length) {
        ...
        var table = $('#disposalAssetTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "/api/disposal-asset-canceled",
            autoWidth: false,
            orderCellsTop: true,
            columns: [
            ...
            initComplete: function () {
                $('.dt-search input').addClass('w-full sm:w-auto bg-white-50 border border-white-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500');
