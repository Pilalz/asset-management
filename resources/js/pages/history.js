    ...
    if (historyTable.length) {
        ...
        var table = $('#historyTable').DataTable({
            ...
            language: {
                ...
                emptyTable: `
                    <div class="flex flex-col items-center justify-center p-8 text-gray-500 dark:text-gray-400">
                        ...
                        <p class="text-lg font-medium">No history data available</p>
                        <p class="text-sm mt-1">There is no history log recorded.</p>
                    </div>`,
                processing: `
                    <style>
            ...
            columnDefs: [
                ...
                {
                    targets: 1,
                    className: 'px-6 py-4 text-gray-600 dark:text-gray-300 align-middle w-40 whitespace-nowrap'
                },
                {
                    targets: 2,
                ...
                {
                    targets: 3,
                    className: 'px-6 py-4 text-gray-500 dark:text-gray-400 align-middle w-40 whitespace-nowrap'
                }
            ],
