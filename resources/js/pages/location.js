        ...
        language: {
            ...
            emptyTable: `
                <div class="flex flex-col items-center justify-center p-8 text-gray-500 dark:text-gray-400">
                    ...
                    <p class="text-lg font-medium">No location data available</p>
                    <p class="text-sm mt-1">Please add a new location data.</p>
                </div>`,
            processing: `
                <style>
