...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //Data for Filtering
    const assetNamesData = window.assetNamesForFilterData || [];
    ...
    function updateSelection() {
        ...
        const $container = $('#asset-ids-container');
        $container.empty();
        
        selectedAssetIds.forEach(id => {
            $('#asset-ids-container').append(
    ...
    if (typeof $ !== 'undefined') {
        $('#assetTable thead tr:eq(0) th').each(function(i) {
            ...
            else if (i === 11 || i === 14 || i === 15 || i === 16 || i === 17 || i === 18 || i === 19 || i === 20) {
        ...
        const table = $('#assetTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: window.getAssetsByIdsUrl.replace('get-assets-by-ids', 'disposal-asset-find'),
                type: "GET",
                data: function(d) {
                    d.form_to_ignore_id = window.currentFormId;
                    d.form_type = window.currentFormType;
                }
            },
            autoWidth: false,
            orderCellsTop: true,
