...
@section('content')
    ...
    <div class="relative overflow-x-auto shadow-md py-5 px-6 rounded-lg m-5 bg-white dark:bg-gray-800">
        <form class="max-w mx-auto" action="{{ route('asset-class.update', $asset_class->id) }}" method="POST">
            ...
            @method('PUT')
            <div class="mb-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Class Name <span
                        class="text-red-900 dark:text-red-400">*</span></label>
                <input type="text" name="name" value="{{ old('name', $asset_class->name) }}"
            ...
            <div class="mb-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Object ID <span
                        class="text-red-900 dark:text-red-400">*</span></label>
                <input type="text" name="obj_id" value="{{ old('obj_id', $asset_class->obj_id) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required />
                @error('obj_id')
                    <div class="text-red-500">{{ $message }}</div>
            ...
            <div class="mb-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Object Acc Name <span
                        class="text-red-900 dark:text-red-400">*</span></label>
                <input type="text" name="obj_acc" value="{{ old('obj_acc', $asset_class->obj_acc) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required />
                @error('obj_acc')
                    <div class="text-red-500">{{ $message }}</div>
