...
@section('content')
    @push('styles')
        <style>
            ...
            #assetClassTable tbody tr:hover {
                background-color: #F9FAFB !important; /* Tailwind's hover:bg-gray-50 */
            }

            /* Gaya untuk Dark Mode */
            .dark #assetClassTable tbody tr:hover {
                        ...
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                            <li class="sm:hidden">
                                <div class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                    <a href="{{ route('asset-class.create') }}" type="button" class="inline-flex items-center me-2">
                            ...
                            <li>
                                <div class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                    <a href="{{ route('asset-class.export') }}" class="inline-flex items-center me-2">
                                        <svg class="w-4 h-4 me-2 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <div class="p-4 md:p-5">
                            <form action="{{ route('asset-class.import') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <a href="{{ asset('template/TemplateAssetClass.xlsx') }}" class="text-blue-600 hover:underline dark:text-blue-500">Download Template Excel</a>
                                </div>
