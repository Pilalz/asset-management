            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-slate-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="px-6 py-5 border-b border-slate-200 dark:border-gray-700 bg-slate-50/50 dark:bg-gray-800/50">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                        Create New Asset Sub Class
                    </h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Fill in the information below to add a new asset sub class to the system.
                    </p>
                </div>

                <!-- Form Section -->
                <form action="{{ route('asset-sub-class.store') }}" method="POST" class="px-6 py-6">
                    @csrf
                    <div class="space-y-6">
                        <!-- Input Select Class -->
                        <div>
