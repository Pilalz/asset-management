            ...
            <div
                ...
                <div class="px-6 py-5 border-b border-slate-200 dark:border-gray-700 bg-slate-50/50 dark:bg-gray-800/50">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                        Edit Asset Sub Class Details
                    </h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Update the information for this asset sub class.
                    </p>
                </div>

                <!-- Form Section -->
                <form action="{{ route('asset-sub-class.update', $asset_sub_class->id) }}" method="POST" class="px-6 py-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Sub Class Name <span class="text-red-500">*</span>
                            </label>
                            <input type="text" name="name" value="{{ old('name', $asset_sub_class->name) }}"
