...
@section('content')
    <div class="bg-white flex p-5 text-lg justify-between">
        ...
        <div class="flex">
            <a href="{{ route('asset-sub-class.create') }}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <tbody>
                @forelse ($assetsubclasses as $asset_sub_class)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">{{ $asset_sub_class->commercial }} (Years)</td>
                        <td class="px-6 py-4">{{ $asset_sub_class->fiscal }} (Years)</td>
                        <td class="px-6 py-4">{{ $asset_sub_class->cost }} (USD)</td>
                        <td>
                            <div class="flex">
                                ...
                                <form action="{{ route('asset-sub-class.destroy', $asset_sub_class->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
