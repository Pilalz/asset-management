...
@section('content')
    @push('styles')
        <style>
            ...
            #assetSubClassTable thead tr td:hover {
        ...
        <div class="flex gap-2">
            @can('is-admin')
                <div class="hidden sm:block">
                    <a href="{{ route('asset-sub-class.create') }}" type="button"
                ...
                <div>
                    ...
                    <div id="dropdownAction"
                        ...
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                            ...
                            <li>
                                <a href="{{ route('asset-sub-class.export') }}" type="button"
                                    class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 transition-colors">
                                    <svg class="w-4 h-4 mr-3 text-gray-400 group-hover:text-indigo-500 dark:text-gray-500 dark:group-hover:text-indigo-400 transition-colors"
                                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                        viewBox="0 0 24 24">
                            ...
                            <form action="{{ route('asset-sub-class.import') }}" method="POST"
                                ...
                                <div class="mb-4">
                                    <div class="flex items-center justify-center w-full">
                                        <label id="asc-file-upload-label"
                                            ...
                                            <div id="asc-file-upload-placeholder"
                                            ...
                                            <div id="asc-file-upload-selected"
                                            ...
                                            <input id="asc-excel-file-input" name="excel_file" type="file" class="hidden"
                                                accept=".xlsx,.xls" required />
                                        </label>
                                    </div>
                                    <script>
                                        document.getElementById('asc-excel-file-input').addEventListener('change', function () {
                                            var fileName = this.files[0] ? this.files[0].name : null;
                                            if (fileName) {
                                                document.getElementById('asc-file-upload-placeholder').classList.add('hidden');
                                                document.getElementById('asc-file-upload-selected').classList.remove('hidden');
                                                document.getElementById('asc-file-upload-selected').classList.add('flex');
                                                document.getElementById('asc-file-name-display').textContent = fileName;
                                            } else {
                                                document.getElementById('asc-file-upload-placeholder').classList.remove('hidden');
                                                document.getElementById('asc-file-upload-selected').classList.add('hidden');
                                                document.getElementById('asc-file-upload-selected').classList.remove('flex');
                                            }
                                        });
                                    </script>
