            ...
            <div
                ...
                <div class="px-6 py-5 border-b border-slate-200 dark:border-gray-700 bg-slate-50/50 dark:bg-gray-800/50">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Update the information for this fixed asset.
                    </p>
                </div>

                <form action="{{ route('asset.update', $asset->id) }}" method="POST" class="px-6 py-6">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 mb-8">
                        ...
                        <div>
                            ...
                            <select name="status"
                                ...
                                <option value="Breakdown" @if($currentStatus == 'Breakdown') selected @endif>Breakdown
                                </option>
                    ...
                    <div
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Commercial Accum
                                Depre
                                <span class="text-red-900 dark:text-red-400">*</span></label>
                            <div class="relative ">
                                <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fiscal Accum Depre
                                <span class="text-red-900 dark:text-red-400">*</span></label>
                            <div class="relative ">
                                <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                    @if($activeCompany->currency === 'USD')
