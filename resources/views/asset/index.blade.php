...
@section('content')
    ...
    <div class="bg-white flex p-5 text-lg justify-between">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('asset.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Asset Class</a>
                    </div>
                </li>
        ...
        <div class="flex">
            <a href="{{ route('asset.create') }}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <tbody>
                @forelse ($assets as $asset)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td>
                            <div class="flex">
                                <a href="{{ route('asset.edit', $asset->id) }}" type="button" class="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-xs px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-green-600 dark:hover:bg-green-700">
                                ...
                                <form action="{{ route('depreciation.depre', $asset->id) }}" method="POST">
                                    @csrf
                                    @method('POST')
                                    <button type="submit"
...
@push('scripts')
<script>
    if (document.getElementById("assetTable") && typeof simpleDatatables.DataTable !== 'undefined') {
        const dataTable = new simpleDatatables.DataTable("#assetTable", {
            searchable: true,
            sortable: true
        });
    }
