        ...
        <div class="relative overflow-x-auto shadow-md py-5 px-6 rounded-lg bg-white dark:bg-gray-800">
            <form class="max-w mx-auto" action="{{ route('assetLVA.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 mb-5">
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Commercial Useful Life Month</label>
                        <input type="text" name="commercial_useful_life_month" value="{{ old('commercial_useful_life_month', 0) }}" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" readonly />
                    </div>
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fiscal Useful Life Month</label>
                        <input type="text" name="fiscal_useful_life_month" value="{{ old('fiscal_useful_life_month', 0) }}" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" readonly />
                    </div>
                ...
                <div class="flex flex-col gap-2 sm:flex-row">
                    ...
                    <a href="{{ route('assetLVA.index') }}" class="text-gray-900 bg-gray-200 hover:bg-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200">Cancel</a>
                </div>
            </form>
        </div>
    </div>
