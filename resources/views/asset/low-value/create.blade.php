    ...
    <div class="p-5">
        <div class="max-w-full mx-auto">
            <div
                ...
                <form action="{{ route('assetLVA.store') }}" method="POST" class="px-6 py-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 mb-8">
                        ...
                        @php
                            $standardStatuses = ['Active', 'Broken', 'Missing'];
                            $currentStatus = old('status', 'Active'); // Default to Active for new Asset
                        ...
                        <div>
                            ...
                            <select name="status"
                                ...
                                <option value="Broken" @if($currentStatus == 'Broken') selected @endif>Broken</option>
                                <option value="Missing" @if($currentStatus == 'Missing') selected @endif>Missing</option>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <input type="text" name="sn_engine" value="{{ old('sn_engine') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            @error('sn_engine')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="sn_chassis" value="{{ old('sn_chassis') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            @error('sn_chassis')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="sn" value="{{ old('sn') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            @error('sn')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="pareto" value="{{ old('pareto') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            @error('pareto')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                    ...
                    <div
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Capitalized Date
                                <span class="text-red-900 dark:text-red-400">*</span></label>
                            <input type="date" name="capitalized_date" value="{{ old('capitalized_date') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                        ...
                        <div>
                            ...
                            <div class="relative ">
                                ...
                                <input type="text" id="acquisition_value_display" value="{{ old('acquisition_value') }}"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                    <span
                                        class="text-sm text-gray-500 dark:text-gray-400">{{ ($activeCompany->currency ?? 'IDR') === 'USD' ? '$' : 'Rp' }}</span>
                                </div>
                                ...
                                <input type="hidden" id="current_cost_hidden" name="current_cost"
                                    value="{{ old('current_cost', 0) }}" />
                            </div>
                        </div>

                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Commercial Useful
                                Life
                                Month</label>
                            <input type="text" name="commercial_useful_life_month"
                                value="{{ old('commercial_useful_life_month', 0) }}"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="hidden" id="commercial_nbv_hidden" name="commercial_nbv"
                                    value="{{ old('commercial_nbv', 0) }}" />
                            </div>
                        </div>

                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fiscal Useful Life
                                Month</label>
                            <input type="text" name="fiscal_useful_life_month"
                                value="{{ old('fiscal_useful_life_month', 0) }}"
                                class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                                readonly />
                        </div>

                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fiscal Net Book
                                Value</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                    <span
                                ...
                                <input type="text" id="fiscal_nbv_display"
                                    class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                                    readonly />
                                <input type="hidden" id="fiscal_nbv_hidden" name="fiscal_nbv"
                                    value="{{ old('fiscal_nbv', 0) }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <input type="text" name="remaks" value="{{ old('remaks') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            @error('remaks')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row gap-3 pt-5 border-t border-slate-100 dark:border-gray-700">
                        <button type="submit"
                            class="text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800 transition-all shadow-sm focus:outline-none w-full sm:w-auto">Save
                            Asset</button>
                        <a href="{{ route('assetLVA.index') }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            async function loadSubClasses(classId, selectedSubClassId = null) {
                ...
                // Jika ada sub class yang terpilih (dari validation error), load asset names
            ...
            // Trigger load jika terjadi validasi error dan old value ada
            if (classSelect.value) {
                loadSubClasses(classSelect.value, initialSubClassId);
            }

            // --- 2. Currency & Sync Values ---
            ...
            function processAndSyncValue(inputValue) {
                ...
                // Untuk Aset Baru LVA: Current Cost dan NBV biasanya = Acquisition Value (sebelum depresiasi)
