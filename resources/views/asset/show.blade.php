...
@section('content')
    ...
    <div class="p-5">
        <div class="overflow-x-auto shadow-md sm:rounded-lg bg-white p-4 dark:bg-gray-800">
                ...
                <div class="w-1/2">
                    <table>
                        ...
                        <tr>
                            <td>Accum Depre</td>
                            <td class="px-2">:</td>
                            <td>{{ '$ ' . number_format($asset->accum_depre, 0, '.', ',') }}</td>
                        </tr>
                        <tr>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-3 bg-white p-4">
            <p>Depreciation</p>
