...
@section('content')
        ...
        <div class="flex gap-2">
            @can('is-admin')
                <div class="hidden sm:block">
                    <a href="{{ route('company-user.create') }}" type="button"
    ...
    <div class="p-5">
        <div class="shadow-sm rounded-xl bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 overflow-hidden">
            <table id="userTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-100">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-white">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3"><span class="flex items-center">Email</span></th>
