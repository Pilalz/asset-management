        ...
        <form action="{{ $deleteUrl }}" method="POST">
            ...
            <div class="text-red-700 hover:text-white">
                <button type="submit"
                    ...
                    class="border border-red-700 hover:bg-red-800 font-medium rounded-lg text-xs px-5 py-2.5 text-center inline-flex items-center me-2 dark:border-red-500 dark:text-red-500 dark:hover:bg-red-600">
