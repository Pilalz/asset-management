            ...
            <div
                ...
                <div class="px-6 py-5 border-b border-slate-200 dark:border-gray-700 bg-slate-50/50 dark:bg-gray-800/50">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Fill in the information below to add a new department to the system.
                    </p>
                </div>

                <!-- Form Section -->
                <form action="{{ route('department.store') }}" method="POST" class="px-6 py-6">
                    @csrf
                    <div class="space-y-6">
                        <!-- Input Name -->
                        <div>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4"
                                ...
                                placeholder="e.g. Human Resources and General Affairs">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
