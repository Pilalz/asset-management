...
@section('content')
    @push('styles')
        <style>
            /* Matiin Outline */
            #departmentTable thead tr th:hover {
                ...
                <div>
                    ...
                    <div id="dropdownAction"
                        ...
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                            ...
                            <li>
                                <a href="{{ route('department.export') }}" type="button"
                                    class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 transition-colors">
                                    <svg class="w-4 h-4 mr-3 text-gray-400 group-hover:text-indigo-500 dark:text-gray-500 dark:group-hover:text-indigo-400 transition-colors"
                                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                        viewBox="0 0 24 24">
                            ...
                            <form action="{{ route('department.import') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    <div class="flex items-center justify-center w-full">
                                        <label id="dept-file-upload-label"
                                            ...
                                            <div id="dept-file-upload-placeholder"
                                            ...
                                            <div id="dept-file-upload-selected"
                                            ...
                                            <input id="dept-excel-file-input" name="excel_file" type="file" class="hidden"
                                                accept=".xlsx,.xls" required />
                                        </label>
                                    </div>
                                    <script>
                                        document.getElementById('dept-excel-file-input').addEventListener('change', function () {
                                            var fileName = this.files[0] ? this.files[0].name : null;
                                            if (fileName) {
                                                document.getElementById('dept-file-upload-placeholder').classList.add('hidden');
                                                document.getElementById('dept-file-upload-selected').classList.remove('hidden');
                                                document.getElementById('dept-file-upload-selected').classList.add('flex');
                                                document.getElementById('dept-file-name-display').textContent = fileName;
                                            } else {
                                                document.getElementById('dept-file-upload-placeholder').classList.remove('hidden');
                                                document.getElementById('dept-file-upload-selected').classList.add('hidden');
                                                document.getElementById('dept-file-upload-selected').classList.remove('flex');
                                            }
                                        });
                                    </script>
                                ...
                                <div class="mb-6 flex justify-center">
                                    <a href="{{ asset('template/TemplateDepartment.xlsx') }}"
    ...
    <div class="p-5">
        <div
            ...
            <table id="departmentTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-100">
