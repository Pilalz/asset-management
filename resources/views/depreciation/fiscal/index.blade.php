...
@section('content')
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('depreciationFiscal.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-indigo-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Fiscal</a>
                    </div>
                </li>
    ...
    <div class="p-5">
        ...
        <div class="mb-5 flex flex-col sm:flex-row flex-wrap gap-4">
            <form method="GET" action="{{ route('depreciationFiscal.index') }}" class="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-slate-200 dark:bg-gray-800 dark:border-gray-700 w-full md:w-auto">
            ...
            <form method="GET" action="{{ route('depreciationFiscal.index', ['start' => now()->year, 'end' => now()->year]) }}" class="flex items-center bg-white p-4 rounded-xl shadow-sm border border-slate-200 dark:bg-gray-800 dark:border-gray-700 w-full md:w-auto">
