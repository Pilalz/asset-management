...
@section('content')
    @push('styles')
        <style>
            ...
            #disposalAssetTable tbody tr:hover {
                background-color: #F9FAFB !important;
                /* Tailwind's hover:bg-gray-50 */
            }

            /* Gaya untuk Dark Mode */
            .dark #disposalAssetTable tbody tr:hover {
                background-color: #374151 !important;
                /* Tailwind's dark:hover:bg-gray-700 (contoh) */
            }

            /* Matiin Outline */
            #disposalAssetTable thead tr th:hover {
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('disposal-asset.index') }}"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-indigo-600 md:ms-2 dark:text-gray-400 dark:hover:text-indigo-400 transition-colors">Disposal
                            Asset</a>
                    </div>
                </li>
    ...
    <div class="p-5">
        <div
            ...
            <table id="disposalAssetTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-100">
...
@push('scripts')
    @vite('resources/js/pages/disposalAssetCanceled.js')
@endpush