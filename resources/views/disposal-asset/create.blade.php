    ...
    <div class="p-5">
        ...
        <form class="max-w mx-auto" action="{{ route('disposal-asset.store') }}" method="POST">
                ...
                <div class="hidden rounded-b-lg" id="formulir" role="tabpanel" aria-labelledby="formulir-tab">
                    <div class="relative overflow-x-auto py-5 px-6 sm:rounded-b-lg bg-white dark:bg-gray-900">
                        ...
                        <div class="mb-5 flex content-center">
                            ...
                            <span> : </span>
                            <input type="number" name="nbv" value="{{ old('nbv') }}" class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:text-white focus:ring-0"/>
                            @error('nbv')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-5 flex content-center">
                            ...
                            <span> : </span>
                            <input type="number" name="esp" value="{{ old('esp') }}" class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:text-white focus:ring-0"/>
                            @error('esp')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-5 flex content-center">
                            ...
                            <span> : </span>
                            <input type="number" name="kurs" value="{{ old('kurs') }}" class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:text-white focus:ring-0"/>
                            @error('kurs')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="px-5 pb-5 rounded-b-lg bg-white shadow-md">
                ...
                <a href="{{ route('disposal-asset.index') }}" class="text-gray-900 bg-gray-200 hover:bg-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-700 dark:hover:bg-gray-600 ml-2">Cancel</a>
            </div>
        </form>
    </div>
@endsection
