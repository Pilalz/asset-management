                ...
                <div class="hidden rounded-b-lg" id="formulir" role="tabpanel" aria-labelledby="formulir-tab">
                    <div
                        ...
                        <div class="mb-5 flex content-center">
                            ...
                            <span> : </span>
                            <input type="text" name="polish_no" value="{{ old('polish_no') }}"
                        ...
                        <div class="mb-5 flex content-center">
                            ...
                            <span> : </span>
                            <input type="text" name="instance_name" value="{{ old('instance_name') }}"
                                class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:bg-gray-800 dark:text-white focus:ring-0 focus:border-indigo-600" />
                            @error('instance_name')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-5 flex content-center">
                            ...
                            <span> : </span>
                            <input type="text" id="annual-display" value="{{ old('annual_premium') }}"
                                class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:bg-gray-800 dark:text-white focus:ring-0 focus:border-indigo-600" />
