        ...
        <form class="max-w mx-auto" action="{{ route('insurance.update', $insurance->id) }}" method="POST">
            <div id="default-tab-content">
                <div class="hidden rounded-b-lg" id="formulir" role="tabpanel" aria-labelledby="formulir-tab">
                    <div
                        class="relative overflow-x-auto py-5 px-6 sm:rounded-b-lg bg-white dark:bg-gray-800 dark:text-white">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-5 flex content-center">
                            ...
                            <span> : </span>
                            <input type="text" name="polish_no" value="{{ old('polish_no', $insurance->polish_no) }}"
                                class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:bg-gray-800 dark:text-white focus:ring-0 focus:border-indigo-600" />
                            @error('polish_no')
                        ...
                        <div class="mb-5 flex content-center">
                            <label class="w-48 text-sm font-medium text-gray-900 dark:text-white">Start Date <span
                                    class="text-red-900 dark:text-red-400">*</span></label>
                            <span> : </span>
                            <input type="date" name="start_date" value="{{ old('start_date', $insurance->start_date) }}"
                                class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:bg-gray-800 dark:text-white focus:ring-0 focus:border-indigo-600" />
                            @error('start_date')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-5 flex content-center">
                            <label class="w-48 text-sm font-medium text-gray-900 dark:text-white">End Date <span
                                    class="text-red-900 dark:text-red-400">*</span></label>
                            <span> : </span>
                            <input type="date" name="end_date" value="{{ old('end_date', $insurance->end_date) }}"
                                class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:bg-gray-800 dark:text-white focus:ring-0 focus:border-indigo-600" />
                            @error('end_date')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-5 flex content-center">
                            ...
                            <input type="text" name="instance_name"
                                value="{{ old('instance_name', $insurance->instance_name) }}"
                                class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:bg-gray-800 dark:text-white focus:ring-0 focus:border-indigo-600" />
                            @error('instance_name')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-5 flex content-center">
                            ...
                            <span> : </span>
                            <input type="text" id="annual-display"
                                value="{{ old('annual_premium', $insurance->annual_premium) }}"
                                class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:bg-gray-800 dark:text-white focus:ring-0 focus:border-indigo-600" />
                            <input type="hidden" id="annual-value" name="annual_premium"
                                value="{{ old('annual_premium', $insurance->annual_premium) }}" />
                        ...
                        <div class="mb-5 flex flex-col gap-2 content-center">
                            <label class="flex w-48 text-sm font-medium text-gray-900 dark:text-white">Status <span
                                    class="text-red-900 dark:text-red-400">*</span></label>
                            <div class="flex flex-row gap-5">
                                <div
                                    class="flex items-center ps-4 border border-gray-200 hover:border-green-600 rounded-sm dark:border-gray-700">
                                    <input id="bordered-radio-1" type="radio" value="Active" name="status"
                                        class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                        {{ old('status', $insurance->status) == "Active" ? 'checked' : '' }}>
                                    <label for="bordered-radio-1"
                                        class="w-full py-4 pr-4 ms-2 text-sm font-medium cursor-pointer"><span
                                            class="bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300 rounded-sm p-1">Active</span></label>
                                </div>
                                <div
                                    class="flex items-center ps-4 border border-gray-200 hover:border-gray-600 rounded-sm dark:border-gray-700">
                                    <input id="bordered-radio-2" type="radio" value="Inactive" name="status"
                                        ...
                                        {{ old('status', $insurance->status) == "Inactive" ? 'checked' : '' }}>
                                    <label for="bordered-radio-2"
                                        class="w-full py-4 pr-4 ms-2 text-sm font-medium cursor-pointer"><span
                                            class="bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-300 rounded-sm p-1">Inactive</span></label>
                                </div>
                            </div>
                            @error('status')
                                <div class="text-red-500">{{ $message }}</div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (typeof $ !== 'undefined') {
                $('#assetTable thead tr:eq(0) th').each(function (i) {
                    ...
                    $(cell).html('<input type="text" class="w-auto p-2 mx-2 my-2 text-xs border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Search..." />');
                });
                    ...
                    language: {
                        ...
                        emptyTable: `
                                <div class="flex flex-col items-center justify-center p-8 text-gray-500 dark:text-gray-400">
                                    ...
                                    <p class="text-lg font-medium">No asset data available</p>
                                </div>`,
                        processing: `
                                <style>
