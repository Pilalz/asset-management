                    ...
                    <div
                        ...
                        <div class="mb-5 flex content-center">
                            ...
                            <input type="text" name="polish_no" value="{{ old('polish_no', $insurance->polish_no) }}"
                                class="px-1 w-full text-sm border-0 border-b-2 border-gray-300 text-gray-900 appearance-none dark:bg-gray-800 dark:text-white focus:ring-0" />
                            @error('polish_no')
                        ...
                        <div class="mb-5 flex flex-col gap-2 content-center">
                            ...
                            <div class="flex flex-row gap-5">
                                <div
                                    ...
                                    <label for="bordered-radio-1" class="w-full py-4 pr-4 ms-2 text-sm font-medium"><span
                                ...
                                <div
                                    ...
                                    <label for="bordered-radio-2" class="w-full py-4 pr-4 ms-2 text-sm font-medium"><span
