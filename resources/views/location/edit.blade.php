    ...
    <div class="p-5">
        <div class="max-w-full mx-auto">
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-slate-200 dark:border-gray-700 overflow-hidden">
                ...
                <!-- Form Section -->
                <form action="{{ route('location.update', $location->id) }}" method="POST" class="px-6 py-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4"
                                ...
                                placeholder="e.g. South Kalimantan Storage Facility">{{ old('description', $location->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
