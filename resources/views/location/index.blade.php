            ...
            <tbody>
                @forelse ($locations as $location)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td>
                            <div class="flex">
                                <a href="{{ route('location.edit', $location->id) }}" type="button" class="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-xs px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-green-600 dark:hover:bg-green-700">
                                ...
                                <form action="{{ route('location.destroy', $location->id) }}" method="POST" class="group">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
