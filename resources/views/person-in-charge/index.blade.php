...
@section('content')
    @push('styles')
        <style>
            ...
            #personInChargeTable tbody tr:hover {
                background-color: #F9FAFB !important; /* Tailwind's hover:bg-gray-50 */
            }

            /* Gaya untuk Dark Mode */
            .dark #personInChargeTable tbody tr:hover {
    ...
    <div class="bg-white flex p-5 text-lg justify-between">
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li class="inline-flex items-center">
                    <a href="{{ route('person-in-charge.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
        ...
        <div class="flex">
            <a href="{{ route('person-in-charge.create') }}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <div class="p-5">
        <div class="relative overflow-x-auto shadow-md rounded-lg bg-white p-4">
            <table id="personInChargeTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (typeof $ !== 'undefined') {
            $('#personInChargeTable thead tr:eq(0) th').each(function(i) {
            ...
            var table = $('#personInChargeTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('api.person-in-charge') }}",
            autoWidth: false,
            orderCellsTop: true,
            columns: [
            ...
            initComplete: function () {
                ...
                this.api().columns().every(function (index) {
                    var column = this;
                    var cell = $('#personInChargeTable thead #filter-row').children().eq(column.index());
        ...
        table.columns().every(function() {
            ...
            $('input', $('#personInChargeTable thead #filter-row').children().eq(this.index())).on('keyup change clear', function(e) {
