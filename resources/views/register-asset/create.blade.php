...
@section('content')
    ...
    <div class="p-5">
        <div class="shadow-sm rounded-xl p-6 bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 mx-auto">
            <form class="max-w mx-auto" action="{{ route('register-asset.store') }}" method="POST"
                ...
                <div class="grid grid-cols-1 gap-y-5 mb-5 dark:text-white">
                    ...
                    <div class="flex content-center">
                        <label class="w-48 text-sm font-medium text-gray-900 dark:text-white">Select Department <span
                                class="text-red-900 dark:text-red-400">*</span></label>
                        <span> : </span>
                    ...
                    <div class="flex content-center">
                        <label class="w-48 text-sm font-medium text-gray-900 dark:text-white">Select Location <span
                                class="text-red-900 dark:text-red-400">*</span></label>
                        <span> : </span>
                ...
                <div class="grid grid-cols-1 gap-y-5 mb-5 dark:text-white">
                    ...
                    <div class="flex content-center">
                        <label class="w-48 text-sm font-medium text-gray-900 dark:text-white">Asset Type <span
                                class="text-red-900 dark:text-red-400">*</span></label>
                        <span> : </span>
                        <div class="w-full flex ml-2">
                            <div class="flex items-center pr-4">
                                <input id="fixed-asset" checked name="asset_type" type="radio" value="FA"
                        ...
                        <div class="border-2 border-black rounded-lg p-4 dark:border-gray-400">
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-100">
                                    <thead
                                        class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-100">
                                        <tr>
                                            <th scope="col" class="px-2 py-3">No</th>
                                            <th scope="col" class="px-2 py-3">PO No.</th>
                                            <th scope="col" class="px-2 py-3">Invoice No.</th>
                                            <th scope="col"
                                                class="px-2 py-3 commission-date-th overflow-hidden transition-all duration-500 ease-in-out">
                                                Commission Date</th>
                                    ...
                                    <tbody id="asset-list-body">
                                        ...
                                        @foreach($initialAssets as $index => $assetData)
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 asset-row">
                                                <td
                                                    class="px-2 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white asset-row-number text-center">
                                                    {{ $loop->iteration }}
                                                </td>
                                                <td class="px-2 py-4">
                                                ...
                                                <td class="px-2 py-4">
                                                    <button type="button"
                                                        class="text-red-600 hover:text-red-900 delete-row-btn">Delete</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Insured <span
                                class="text-red-900 dark:text-red-400">*</span></label>
                        <div class="flex items-center mb-4">
                            <input id="insured-yes" name="insured" type="radio" value="1"
                                class="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                {{ old('insured', 1) == 1 ? 'checked' : '' }}>
                            <label for="insured-yes" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ya
                                <span class="italic">(Yes)</span></label>
                        </div>
                        <div class="flex items-center">
                            <input id="insured-no" name="insured" type="radio" value="0"
                                class="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                {{ old('insured') == 0 ? 'checked' : '' }}>
                    ...
                    <div id="polish-no-wrapper"
                        class="flex content-center overflow-hidden transition-all duration-500 ease-in-out">
                        <label class="w-48 text-sm font-medium text-gray-900 dark:text-white">Polish No. <span
                                class="text-red-900 dark:text-red-400">*</span></label>
                        <span> : </span>
                        <input type="text" id="polish-no-input" name="polish_no" value="{{ old('polish_no') }}"
                ...
                <div class="grid grid-cols-1 gap-y-5 mb-5">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Anda bisa melampirkan lebih dari satu file, satu file maksimal
                            5MB.</p>
                    </div>
                </div>
                    ...
                    <div>
                        <div class="border-2 border-black rounded-lg p-4 dark:border-gray-400">
                            ...
                            <div class="flex flex-row mb-2">
                                <label class="w-auto mr-2 text-sm font-medium text-gray-900 dark:text-white">Sequence <span
                                        class="text-red-900 dark:text-red-400">*</span> : </label>
                                <div class="flex items-center pr-4">
                                    ...
                                    <tbody id="approval-list-body">
                                        ...
                                        <tr class="approval-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            <th scope="row"
                                                ...
                                                <input type="text" name="approvals[0][approval_action]" value="Submitted by"
                                            ...
                                            <th scope="row"
                                                class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[0][role]" value="Asset Management"
                                                    class="approval-role border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                            ...
                                            <td class="px-2 py-4">
                                                <select name="approvals[0][user_id]"
                                                    ...
                                                    @foreach($users as $user)
                                                        ...
                                                        <option value="{{ $user->id }}" data-role="{{ $user->user_role }}" {{ old("approvals.0.user_id", $approvals[0]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                            {{ $user->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td class="px-2 py-4">
                                                <input type="text" name="approvals[0][status]" value="Pending"
                                            ...
                                            <td class="px-2 py-4">
                                                <input type="date" name="approvals[0][approval_date]"
                                                    class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                    readonly />
                                        ...
                                        <tr class="approval-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            <th scope="row"
                                                class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[1][approval_action]" value="Checked by"
                                                    class="border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                            ...
                                            <th scope="row"
                                                class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[1][role]" value="User Manager"
                                                    class="approval-role border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                            ...
                                            <td class="px-2 py-4">
                                                <select name="approvals[1][user_id]"
                                                    ...
                                                    @foreach($users as $user)
                                                        {{-- Tambahkan atribut data-role di sini --}}
                                                        <option value="{{ $user->id }}" data-role="{{ $user->user_role }}" {{ old("approvals.1.user_id", $approvals[1]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                            {{ $user->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td class="px-2 py-4">
                                                <input type="text" name="approvals[1][status]" value="Pending"
                                                    class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                    readonly />
                                            ...
                                            <td class="px-2 py-4">
                                                <input type="date" name="approvals[1][approval_date]"
                                                    class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                    readonly />
                                        ...
                                        <tr class="approval-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            <th scope="row"
                                                class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[2][approval_action]" value="Approved by"
                                                    class="border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                            ...
                                            <th scope="row"
                                                class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[2][role]" value="CFO"
                                                    class="approval-role border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                            ...
                                            <td class="px-2 py-4">
                                                <select name="approvals[2][user_id]"
                                                    ...
                                                    @foreach($users as $user)
                                                        {{-- Tambahkan atribut data-role di sini --}}
                                                        <option value="{{ $user->id }}" data-role="{{ $user->user_role }}" {{ old("approvals.2.user_id", $approvals[2]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                            {{ $user->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td class="px-2 py-4">
                                                <input type="text" name="approvals[2][status]" value="Pending"
                                                    class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                    readonly />
                                            ...
                                            <td class="px-2 py-4">
                                                <input type="date" name="approvals[2][approval_date]"
                                                    class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                    readonly />
                                        ...
                                        <tr class="approval-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            <th scope="row"
                                                class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[3][approval_action]" value="Approved by"
                                                    class="border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                            ...
                                            <th scope="row"
                                                class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[3][role]" value="Director"
                                                    class="approval-role border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                            ...
                                            <td class="px-2 py-4">
                                                <select name="approvals[3][user_id]"
                                                    ...
                                                    @foreach($users as $user)
                                                        {{-- Tambahkan atribut data-role di sini --}}
                                                        <option value="{{ $user->id }}" data-role="{{ $user->user_role }}" {{ old("approvals.3.user_id", $approvals[3]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                            {{ $user->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td class="px-2 py-4">
                                                <input type="text" name="approvals[3][status]" value="Pending"
                                                    class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                    readonly />
                                            ...
                                            <td class="px-2 py-4">
                                                <input type="date" name="approvals[3][approval_date]"
                                                    class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                    readonly />
