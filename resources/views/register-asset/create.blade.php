                                ...
                                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody id="approval-list-body">
                                        ...
                                        <tr class="approval-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <th scope="row" class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[0][role]" value="Asset Management" class="approval-role border-0 focus:ring-0 dark:bg-gray-800" readonly/>
                                        ...
                                        <tr class="approval-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            <th scope="row" class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[1][approval_action]" value="Checked by" class="border-0 focus:ring-0 dark:bg-gray-800" readonly/>
                                        ...
                                        <tr class="approval-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <th scope="row" class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[2][role]" value="CFO" class="approval-role border-0 focus:ring-0 dark:bg-gray-800" readonly/>
                                        ...
                                        <tr class="approval-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            <th scope="row" class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[3][approval_action]" value="Approved by" class="border-0 focus:ring-0 dark:bg-gray-800" readonly/>
                                                @error("approvals[3][approval_action]")
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </th>
                                            <th scope="row" class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[3][role]" value="Director" class="approval-role border-0 focus:ring-0 dark:bg-gray-800" readonly/>
