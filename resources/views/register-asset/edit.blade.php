        ...
        <form class="max-w mx-auto" action="{{ route('register-asset.update', $register_asset->id) }}" method="POST"
            ...
            <div class="grid grid-cols-1 gap-y-5 mb-5 dark:text-white">
                ...
                <div class="flex content-center">
                    ...
                    <input type="hidden" name="form_no" value="{{ old('form_no', $register_asset->form_no) }}"
            ...
            <div class="grid grid-cols-1 gap-y-5 mb-5">
                ...
                <div id="polish-no-wrapper"
                    class="flex content-center overflow-hidden transition-all duration-500 ease-in-out dark:text-white">
            ...
            <div class="grid grid-cols-1 gap-y-5 mb-5">
                ...
                <div>
                    ...
                    <input name="attachments[]"
                        class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-300 dark:border-gray-500 focus:outline-none"
                        type="file" multiple>
                </div>
            </div>
                                        ...
                                        <tr class="approval-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            <th scope="row"
                                                ...
                                                <input type="text" name="approvals[{{$index}}][approval_action]"
                                                    value="{{ $action }}" class="border-0 focus:ring-0 dark:bg-gray-800"
                                                    readonly />
                                            ...
                                            <th scope="row"
                                                class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <input type="text" name="approvals[{{$index}}][role]" value="{{ $role }}"
                                            ...
                                            <td class="px-2 py-4">
                                                <input type="text" name="approvals[{{$index}}][status]" value="{{ $status }}"
