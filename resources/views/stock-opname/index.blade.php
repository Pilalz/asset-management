...
@section('content')
                        ...
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                            <li class="sm:hidden">
                                <div class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                    <a href="{{ route('stock-opname.create') }}" type="button" class="inline-flex items-center me-2">
    ...
    <div class="p-5">
        <div class="relative overflow-x-auto shadow-md rounded-lg bg-white p-4 dark:bg-gray-800">
            <table id="stockOpnameTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-100">
