                        ...
                        <div class="grid grid-cols-1 gap-y-5 mb-5 dark:text-white">
                            ...
                            <div class="flex content-center">
                                ...
                                <input type="hidden" name="form_no" value="{{ $form_no }}"
                                    class="w-full px-1 text-sm text-gray-900 appearance-none dark:text-white" readonly />
                                @error('form_no')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="flex content-center">
                                <label class="w-48 text-sm font-medium text-gray-900 dark:text-white">Destination Location
                                    <span class="text-red-900 dark:text-red-400">*</span></label>
                                <span> : </span>
                        ...
                        <div class="grid grid-cols-1 gap-y-5 mb-5">
                            ...
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                    for="attachments">Upload Attachment</label>
                                <input name="attachments[]"
                                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                    id="attachments" type="file" multiple>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Anda bisa melampirkan lebih dari
                                    satu file, satu file maksimal 5MB.</p>
                            </div>
                        </div>
                                            ...
                                            <tbody id="asset-list-body">
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <th scope="row"
                                                        ...
                                                        <input type="text" name="approvals[0][approval_action]"
                                                            value="Submitted by"
                                                    ...
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[0][role]" value="User"
                                                        ...
                                                        <select name="approvals[0][user_id]"
                                                            ...
                                                            @foreach($users as $user)
                                                                ...
                                                                <option value="{{ $user->id }}"
                                                                    data-role="{{ $user->user_role }}" {{ old("approvals.0.user_id", $approvals[0]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                                    {{ $user->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <tr
                                                    class="approval-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[1][approval_action]"
                                                            value="Known by" class="border-0 focus:ring-0 dark:bg-gray-800"
                                                            readonly />
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <select name="approvals[1][user_id]"
                                                            ...
                                                            @foreach($users as $user)
                                                                {{-- Tambahkan atribut data-role di sini --}}
                                                                <option value="{{ $user->id }}"
                                                                    data-role="{{ $user->user_role }}" {{ old("approvals.1.user_id", $approvals[1]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                                    {{ $user->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <tr
                                                    ...
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[2][approval_action]"
                                                            value="Approved by"
                                                            class="border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                                    ...
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[2][role]" value="Site Director"
                                                            class="approval-role border-0 focus:ring-0 dark:bg-gray-800"
                                                            readonly />
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <select name="approvals[2][user_id]"
                                                            ...
                                                            @foreach($users as $user)
                                                                {{-- Tambahkan atribut data-role di sini --}}
                                                                <option value="{{ $user->id }}"
                                                                    data-role="{{ $user->user_role }}" {{ old("approvals.2.user_id", $approvals[2]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                                    {{ $user->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <tr
                                                    ...
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[3][approval_action]"
                                                            value="Checked by"
                                                            class="border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                                    ...
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[3][role]"
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <select name="approvals[3][user_id]"
                                                            ...
                                                            @foreach($users as $user)
                                                                {{-- Tambahkan atribut data-role di sini --}}
                                                                <option value="{{ $user->id }}"
                                                                    data-role="{{ $user->user_role }}" {{ old("approvals.3.user_id", $approvals[3]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                                    {{ $user->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <tr
                                                    ...
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[4][approval_action]"
                                                            value="Approved by"
                                                            class="border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                                    ...
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[4][role]" value="CFO"
                                                            class="approval-role border-0 focus:ring-0 dark:bg-gray-800"
                                                            readonly />
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <select name="approvals[4][user_id]"
                                                            ...
                                                            @foreach($users as $user)
                                                                {{-- Tambahkan atribut data-role di sini --}}
                                                                <option value="{{ $user->id }}"
                                                                    data-role="{{ $user->user_role }}" {{ old("approvals.4.user_id", $approvals[4]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                                    {{ $user->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <input type="text" name="approvals[4][status]" value="Pending"
                                                            class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                            readonly />
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <input type="date" name="approvals[4][approval_date]"
                                                            class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                            readonly />
                                                ...
                                                <tr
                                                    ...
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[5][approval_action]"
                                                            value="Approved by"
                                                            class="border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                                    ...
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[5][role]" value="Director"
                                                            class="approval-role border-0 focus:ring-0 dark:bg-gray-800"
                                                            readonly />
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <select name="approvals[5][user_id]"
                                                            ...
                                                            @foreach($users as $user)
                                                                {{-- Tambahkan atribut data-role di sini --}}
                                                                <option value="{{ $user->id }}"
                                                                    data-role="{{ $user->user_role }}" {{ old("approvals.5.user_id", $approvals[5]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                                    {{ $user->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <input type="text" name="approvals[5][status]" value="Pending"
                                                            class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                            readonly />
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <input type="date" name="approvals[5][approval_date]"
                                                            class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                            readonly />
                                                ...
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[6][approval_action]"
                                                            value="Accepted by"
                                                            class="border-0 focus:ring-0 dark:bg-gray-800" readonly />
                                                    ...
                                                    <th scope="row"
                                                        class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <input type="text" name="approvals[6][role]" value="User"
                                                            class="approval-role border-0 focus:ring-0 dark:bg-gray-800"
                                                            readonly />
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <select name="approvals[6][user_id]"
                                                            ...
                                                            @foreach($users as $user)
                                                                {{-- Tambahkan atribut data-role di sini --}}
                                                                <option value="{{ $user->id }}"
                                                                    data-role="{{ $user->user_role }}" {{ old("approvals.6.user_id", $approvals[6]->user_id ?? '') == $user->id ? 'selected' : '' }}>
                                                                    {{ $user->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <input type="text" name="approvals[6][status]" value="Pending"
                                                            class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                            readonly />
                                                    ...
                                                    <td class="px-2 py-4">
                                                        <input type="date" name="approvals[6][approval_date]"
                                                            class="block py-1 px-0 w-full text-sm text-center text-gray-900 bg-transparent border-0 appearance-none dark:text-white focus:outline-none focus:ring-0 peer"
                                                            readonly />
...
@push('scripts')
    @vite('resources/js/pages/transferAssetForm.js')
@endpush