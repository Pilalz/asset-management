            ...
            <div class="border-b bg-white rounded-t-lg border-gray-200 dark:border-gray-700 dark:bg-gray-800">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab"
                    ...
                    <li class="me-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 rounded-t-lg" id="formulir-tab"
                            data-tabs-target="#formulir" type="button" role="tab" aria-controls="formulir"
                            aria-selected="false">Form <span class="text-red-900 dark:text-red-400">*</span></button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button
            ...
            <div id="default-tab-content">
                    ...
                    <div class="relative overflow-x-auto py-5 px-6 bg-white dark:bg-gray-800">
                        ...
                        <div class="grid grid-cols-1 gap-y-5 mb-5 dark:text-white">
                            ...
                            <div class="flex content-center">
                                ...
                                <span> : </span>
                                <p class="w-full px-2">
                                    {{ old("transfer_asset.submit_date", $transfer_asset->submit_date ?? '') }}
                                </p>
                                <input type="hidden" name="submit_date"
                                    value="{{ old("transfer_asset.submit_date", $transfer_asset->submit_date ?? '') }}"
                            ...
                            <div class="flex content-center">
                                ...
                                <input type="hidden" name="form_no" value="{{ old('form_no', $transfer_asset->form_no) }}"
                            ...
                            <div class="flex content-center">
                                <label class="w-48 text-sm font-medium text-gray-900 dark:text-white">Department <span
                                        class="text-red-900 dark:text-red-400">*</span></label>
                                <span> : </span>
                                <select name="department_id"
                                    ...
                                    @foreach($departments as $department)
                                        <option value="{{ $department->id }}" {{ old('department_id', $transfer_asset->department_id) == $department->id ? 'selected' : '' }}>
                                            {{ $department->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="flex content-center">
                                <label class="w-48 text-sm font-medium text-gray-900 dark:text-white">Destination Location
                                    <span class="text-red-900 dark:text-red-400">*</span></label>
                                <span> : </span>
                                <select name="destination_loc_id"
                                    class="px-1 mx-1 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:bg-gray-800 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                            ...
                            <div>
                                ...
                                <textarea type="text" name="reason"
                                    class="block py-1 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                                            {{ old('reason', $transfer_asset->reason ?? '') }}
                                        </textarea>
                                @error('reason')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                                    ...
                                    <div class="flex flex-row mb-2">
                                        ...
                                        <div class="flex items-center pr-4">
                                            <input id="sequence-yes" name="sequence" type="radio" value="1"
                                                ...
                                                {{ old('sequence', $transfer_asset->sequence) == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="flex items-center">
                                            <input id="sequence-no" name="sequence" type="radio" value="0"
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                                {{ old('sequence', $transfer_asset->sequence) == 0 ? 'checked' : '' }}>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table
                                            ...
                                            <tbody id="approval-list-body">
                                                @foreach($transfer_asset->approvals as $index => $approval)
                                                    @php
                ...
                <div class="hidden" id="asset" role="tabpanel" aria-labelledby="asset-tab">
                    <div class="relative overflow-x-auto py-5 px-6 bg-white dark:bg-gray-800">
                        ...
                        <div class="p-4">
                            <span id="selected-count-display" class="font-bold dark:text-gray-200">0 asset(s)
                                selected</span>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    window.initialAssetIds = @json(old('asset_ids', $assetIdsForJs));
    ...
    window.currentFormId = {{ $transfer_asset->id }};
    window.currentFormType = 'transfer';
</script>
