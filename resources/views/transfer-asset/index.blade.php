...
@section('content')
    <div class="bg-white flex p-5 text-lg justify-between">
        ...
        <div class="flex">
            <a href="{{ route('transfer-asset.create') }}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td>
                            <div class="flex">
                                ...
                                <form action="{{ route('transfer-asset.destroy', $transfer_asset->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
...
@push('scripts')
<script>
    if (document.getElementById("transferAssetTable") && typeof simpleDatatables.DataTable !== 'undefined') {
        const dataTable = new simpleDatatables.DataTable("#transferAssetTable", {
            searchable: true,
            sortable: true,
        });
    }
